					...
					<div className='flex-grow-1 ms-3 d-flex justify-content-between align-items-center'>
						<div>
							<Link
								...
								className='fw-bold fs-6 mb-0 link-dark'>
								{name}
							</Link>
...
const DashboardPage = () => {
	...
	const handleOnClickToEmployeeListPage = useCallback(
		() => history.push(demoPages.appointment.subMenu.employeeList.path),
		[history],
	);
				...
				<div className='row'>
					...
					<div className='col-xxl-4'>
						<UserContact
							...
							phone='1234567'
							onChat={() => history.push(demoPages.chat.subMenu.withListChat.path)}
							src={USERS.SAM.src}
							...
							<CardBody>
								<div className='row g-4'>
									<div className='col-md-6'>
										<Card
											className='bg-l25-warning bg-l10-warning-hover transition-base rounded-2 mb-0'
											stretch
											shadow='sm'>
											<CardHeader className='bg-transparent'>
												<CardLabel>
									...
									<div className='col-md-6'>
										<Card
											className='bg-l25-secondary bg-l10-secondary-hover transition-base rounded-2 mb-4'
											shadow='sm'>
											<CardHeader className='bg-transparent'>
												<CardLabel>
													<CardTitle tag='h4' className='h5'>
										...
										<Card
											className='bg-l25-primary bg-l10-primary-hover transition-base rounded-2 mb-0'
											shadow='sm'>
											<CardHeader className='bg-transparent'>
												<CardLabel>
													<CardTitle tag='h4' className='h5'>
					...
					<div className='col-xxl-6'>
						<Card stretch>
							<CardHeader>
								<CardLabel icon='AccountBalance' iconColor='danger'>
									<CardTitle tag='h4' className='h5'>
										Expense
									</CardTitle>
									<CardSubTitle>{activeTab}</CardSubTitle>
							...
							<CardBody>
								<div className='row g-4'>
										...
										<Card
											...
											<CardBody>
												<Chart
													...
													series={tax.series}
													options={tax.options}
													type={tax.options.chart.type}
													height={tax.options.chart.height}
													width={tax.options.chart.width}
												/>
												<div className='d-flex align-items-center pb-3'>
													<div className='flex-shrink-0'>
														<Icon
													...
													<div className='flex-grow-1 ms-3'>
														<div className='fw-bold fs-3 mb-0'>
															{priceFormat(
																average(tax.series[0].data),
															)}
															<PercentComparison
																valueOne={average(
																	tax.series[0].data,
																)}
																valueTwo={tax.tax.compare}
															/>
														</div>
														<div className='text-muted'>
															Compared to (
															{priceFormat(tax.tax.compare)} last{' '}
															{compareLabel(0, true)})
														</div>
													</div>
												</div>
									...
									<div className='col-md-6'>
										<Card
											className='bg-l25-info bg-l10-info-hover transition-base rounded-2 mb-4'
											shadow='sm'>
											<CardHeader className='bg-transparent'>
												<CardLabel>
													<CardTitle tag='h4' className='h5'>
											...
											<CardBody>
												<div className='d-flex align-items-center pb-3'>
													...
													<div className='flex-grow-1 ms-3'>
														<div className='fw-bold fs-3 mb-0'>
															{priceFormat(tax.advertising.price)}
															<PercentComparison
																valueOne={tax.advertising.price}
																valueTwo={tax.advertising.compare}
															/>
														</div>
														<div className='text-muted'>
															Compared to (
															{priceFormat(tax.advertising.compare)}{' '}
															last {compareLabel(0, true)})
														</div>
													</div>
												</div>
										...
										<Card
											...
											<CardBody>
												<div className='d-flex align-items-center pb-3'>
													...
													<div className='flex-grow-1 ms-3'>
														<div className='fw-bold fs-3 mb-0'>
															{priceFormat(tax.other.price)}
															<PercentComparison
																valueOne={tax.other.price}
																valueTwo={tax.other.compare}
															/>
														</div>
														<div className='text-muted'>
															Compared to (
															{priceFormat(tax.other.compare)} last{' '}
															{compareLabel(0, true)})
														</div>
													</div>
												</div>
