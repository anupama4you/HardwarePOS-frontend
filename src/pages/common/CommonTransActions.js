							...
							<div className='row'>
								<div className='col-3'>
									<div className='ratio ratio-1x1'>
										<div className='bg-l10-success rounded-2 d-flex align-items-center justify-content-center'>
											<div>
					...
					<Card>
						<CardBody>
							<div className='row'>
								<div className='col-3'>
									<div className='ratio ratio-1x1'>
										<div className='bg-l10-danger rounded-2 d-flex align-items-center justify-content-center'>
											<div>
