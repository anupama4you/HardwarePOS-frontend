	...
	return (
		<OffCanvas setOpen={setOpen} isOpen={isOpen} isRightPanel>
			<OffCanvasBody className='p-4'>
					...
					<div className='col-auto'>
						<Dropdown>
							<DropdownToggle hasIcon={false}>
								<Button icon='MoreHoriz' color='light' hoverShadow='default' />
							</DropdownToggle>
				...
				<div className='bg-l10-dark rounded-3 shadow-3d-dark'>
									...
									<div className='col-auto'>
										<div
											className={classNames(
												`bg-l10-info text-info fw-bold px-3 py-2 rounded-pill`,
											)}>
											{`${item.person} ${
				...
				<Card className='bg-l25-warning mb-0' isCompact>
					...
					<CardBody>
						...
						<div className='d-flex align-items-center pb-3'>
							<div className='flex-shrink-0'>
								<Icon icon='Speed' size='4x' color='warning' />
							</div>
							<div className='flex-grow-1 ms-3'>
								...
								<div className='text-muted'>Compared to (45% last week)</div>
							</div>
						</div>
					</CardBody>
				</Card>
